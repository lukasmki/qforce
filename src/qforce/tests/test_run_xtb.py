...
frag_lib = {}/qforce_fragments
 """.format(str(outdir))
        ...
        try:
            run_qforce(input_arg=str(xyz), config=str(setting))
        except SystemExit:
            pass
        ...
        run_hessian = (
            ...
            / "propane_qforce"
            / "1_hessian"
            / "propane_a7d7b98c1b9fc86c0ef4eb7905829efa_hessian.inp"
        )
        ...
        os.chdir(
            ...
            / "propane_qforce"
            / "2_fragments"
            / "CC_H8C3_d91b46644317dee9c2b868166c66a18c~1"
        )
        run_fragment = (
            outdir
            / "propane_qforce"
        ...
        try:
            mol = run_qforce(input_arg=str(xyz), config=str(setting))
        except SystemExit:
            pass
