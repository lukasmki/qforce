...
class TorsiondrivexTB:
    ...
    @staticmethod
    def write(
        config, file, dir, scan_id, coords, atnums, scanned_atoms, charge, multiplicity
    ):
        ...
        write(f"{dir}/{scan_id}_torsiondrive/input.xyz", mol, plain=True, comment=cmd)
        ...
        file.write(
            f"torsiondrive-launch input.xyz dihedrals.txt "
